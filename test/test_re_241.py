...
class ReTests(unittest.TestCase):
    ...
    def _test_bug_418626(self):
        # XXX disabled for now, because it takes too long
    ...
    def _test_stack_overflow(self):
        # nasty cases that used to overflow the straightforward recursive
        # implementation of repeated groups.
        # XXX disabled for the moment, because they take too long on _sre.py
